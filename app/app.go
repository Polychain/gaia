...
func NewGaiaApp(
	...
	homePath string, invCheckPeriod uint, encodingConfig gaiaappparams.EncodingConfig, distHooks distrtypes.DistributionHooks, appOpts servertypes.AppOptions, baseAppOptions ...func(*baseapp.BaseApp),
) *GaiaApp {
